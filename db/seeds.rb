...
Restaurant.create(name: "chipotle", num_of_tables: 1)
Restaurant.create(name: "alexander's", num_of_tables: 2)
Table.create(restaurant_id: 2, capacity: 4)
Table.create(restaurant_id: 2, capacity: 2)
Table.create(restaurant_id: 2, capacity: 4)
Table.create(restaurant_id: 2, capacity: 2)
Table.create(restaurant_id: 2, capacity: 4)
Table.create(restaurant_id: 2, capacity: 2)
